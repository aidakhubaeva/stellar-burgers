...
import { mockStore, mockIngredient, mockBun, mockOrder, mockUser, mockIngredient2 } from './mockData';
...
describe('Тесты для Burger Slice', () => {
    ...
    test('должен обновить ингредиенты при fetchBurgerData.fulfilled', () => {
        store.dispatch(fetchBurgerData.fulfilled([mockIngredient, mockBun], 'test-id'));
